      ...
      return (
        <div className="bg-surface-container-lowest p-8 rounded-3xl shadow-sm border border-stone-200/50 space-y-6">
          ...
          <div className="space-y-4 text-sm text-stone-600 leading-relaxed">
            ...
            <p className="mt-4">If a guest submits a complex allergy (e.g., "Allergic to raw tomatoes and kiwi"), FoodOps AI will flag the event for manual review to ensure absolute safety.</p>
          </div>
        </div>
      );
    }
